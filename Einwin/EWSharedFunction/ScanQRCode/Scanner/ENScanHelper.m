...
#import "ENMyQRViewController.h"
#import "LBXScanView.h"
#import <objc/message.h>
#import "LBXScanResult.h"
#import "LBXScanWrapper.h"

@interface ENScanHelper()

@property (nonatomic,strong) LBXScanResult *result;

@end

@implementation ENScanHelper

static ENScanHelper *scanHelper;
...
- (ENScanQRCodeViewController *)ScanVCWithStyle:(QRScanStyle )style qrCodeCallBackBlock:(void (^)(id))block
{
    ...
    ENScanQRCodeViewController *vc = [ENScanQRCodeViewController new];
    vc.style = lbx;
    vc.isQQSimulator = YES;
    vc.isVideoZoom = YES;
    vc.callBackBlock = ^ (id result){
        block(result);
    };
...
- (LBXScanResult *)result{
    _result = [[LBXScanResult alloc] init];
    return _result;
}
@end
