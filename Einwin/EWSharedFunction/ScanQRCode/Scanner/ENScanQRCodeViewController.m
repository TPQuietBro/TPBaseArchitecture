...
@interface ENScanQRCodeViewController ()
@property (nonatomic, strong) LBXScanVideoZoomView *zoomView;

@end

@implementation ENScanQRCodeViewController
...
- (void)showNextVCWithScanResult:(LBXScanResult*)strResult
{
    if (self.callBackBlock) {
        self.callBackBlock(strResult.strScanned);
    }
}
...
- (void)myQRCode
{
    ENMyQRViewController *vc = [ENMyQRViewController new];
